...
Soit $$n \in \mathbb{N}^{*}$$, calculer la somme des elements de $$U_{n}$$ <br>
Soient $$n \in \mathbb{N}^{*}$$ et $$p \in \mathbb{N}^{*}$$, calculer la somme des puissances p-ièmes des éléments de $$U_{n}$$ <br>
