...
c) Pour $n \geq 2$ et $x \in \mathbb{R}$, calculer $\sum_{k=0}^{n-1} cos(x +\frac{2i\pi k}{n})$ <br> 
...
c) On a $\sum_{k=0}^{n-1} cos(x +\frac{2i\pi k}{n}) = \sum_{k=0}^{n-1} cos(x)cos(\frac{2i\pi k}{n}) - sin(x)sin(\frac{2i\pi k}{n}) = cos(x) \sum_{k=0}^{n-1} cos(\frac{2i\pi k}{n}) - sin(x) \sum_{k=0}^{n-1} sin(\frac{2i\pi k}{n}) = cos(x) \times 0 - sin(x) \times 0 = 0$<br>
