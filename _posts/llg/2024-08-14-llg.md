...
6. [Interlude Facile d'accès](#interlude-facile-d'accès-nombres-complexes)
...
<li>3) Pour $a$ complexe, quelle condition pour que tous $x$, $y$ réels, $x + ay = 0 \Leftrightarrow x = y = 0$</li>
<li>Flemme</li>
</ul>
